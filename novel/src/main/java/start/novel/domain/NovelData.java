...
public class NovelData {
    ...
    public NovelData(String novelImage, String novelTitle, Integer author_id, Integer this_novel_Serialization , String author_Nickname , String novel_Description ,Integer novel_genre) {
